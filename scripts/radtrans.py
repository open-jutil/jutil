...
for key in Atmosphere:
    Atmosphere[key] = Atmosphere[key][::-4]
...
#            (20, mini.ScaledSteepestDescentStepper()),
#            (20, mini.LevenbergMarquardtStepper(1e-10, 10)),
#            (20, mini.LevenbergMarquardtStepper2(1e-10, 10.)),
#            (40, mini.GaussNewtonStepper()),
        ...
        x_f =  optimize(J, 250 * np.ones_like(J._x_t))
